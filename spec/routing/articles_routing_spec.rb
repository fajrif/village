...
describe 'village:articles routes' do
  describe 'default routes' do
    ...
    it '/articles/2012/01 to Articles#index with year and month' do
      ...
      { :get => path }.should route_to :controller => 'articles', :action => 'index', :year => '2012', :month => '01'
    end
    ...
    it '/articles/2012/01/01 to Articles#index with year, month and day' do
      ...
      { :get => path }.should route_to :controller => 'articles', :action => 'index', :year => '2012', :month => '01', :day => '01'
    end
    ...
    it '/articles/2012/01/01/test-article to Articles#show with permalink a format of day' do
      ...
      { :get => path }.should route_to :controller => 'articles', :action => 'show', :id => '2012/01/01/test-article'
    end
  end
  ...
  describe 'custom routes' do
    ...
    it '/blog/test-article to Articles#show with a permalink format of slug' do
      ...
      { :get => path }.should route_to :controller => 'articles', :action => 'show', :id => 'test-article'
    end
    ...
    it '/blog/2012/test-article to Articles#show with a permalink format of year' do
      ...
      { :get => path }.should route_to :controller => 'articles', :action => 'show', :id => '2012/test-article'
    end
    ...
    it '/blog/2012/01/test-article to Articles#show with permalink a format of month' do
      ...
      { :get => path }.should route_to :controller => 'articles', :action => 'show', :id => '2012/01/test-article'
    end
